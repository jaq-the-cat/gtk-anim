...
void init_state() {
  ...
  /*fig1.children[2].children[0] = FIG(&fig1.children[2], R(0, -60-40), S_FILLEDCIRCLE, 12, 0, 0.3, 1, 0); // top left*/
  ...
  fig1.children[2].children[0] = FIG(&fig1.children[2], R(-30, -60+50), S_LINE, 12, 0, 0.3, 1, 0); // basically the left arm
